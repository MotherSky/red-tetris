	...
	reducers: {
		...
		onCollision: (state, data) => {
			...
			if (index >= 0) {
				...
				array[index].shape = data.payload.generatedTetros[data.payload.generatedTetrosIndexer - 1];
			}
...
export const { pushSpectators, onCollision, getSpectatorsList, deletePlayer } = Spectators.actions;
